...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF7E07E2);
  late Color secondary = const Color(0xFFC095E2);
  late Color tertiary = const Color(0xFFF6F2FF);
  late Color alternate = const Color(0xFFDDC6F3);
