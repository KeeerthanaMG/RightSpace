...
import 't_eam_request_copy_model.dart';
export 't_eam_request_copy_model.dart';

class TEamRequestCopyWidget extends StatefulWidget {
  const TEamRequestCopyWidget({super.key});

  @override
  State<TEamRequestCopyWidget> createState() => _TEamRequestCopyWidgetState();
}

class _TEamRequestCopyWidgetState extends State<TEamRequestCopyWidget> {
  late TEamRequestCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TEamRequestCopyModel());
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: Image.network(
                                                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2hjdJuEv9fFLpnCL4vW-GIL_ewiAoiGRCK4EfyWQPKLFDpOHGAajoKMirxdYVZPboZDs&usqp=CAU',
                                                  width: 57.0,
                                                  height: 48.0,
                                                  fit: BoxFit.cover,
                                                ),
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'Needed UI/UX Developer,Cloud Architect)          \n                                          2/4  ',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelSmall
                                                      .override(
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Needed Full Stack Developer)             3/4     \n                ',
                                                style:
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('TEamRequestCopy');
                            },
                            child: Icon(
                              Icons.search,
                              color: FlutterFlowTheme.of(context)
